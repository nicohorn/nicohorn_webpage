      ...
      {open && (
        ...
        >
          ...
          <motion.div
            ref={modalRef}
            className={cn(
              "dark:bg-neutral-950 dark:border-neutral-800 relative z-50 flex max-h-[90%] min-h-[50%] flex-1 flex-col overflow-hidden border border-transparent bg-white md:max-w-[40%] md:rounded-2xl",
              className,
            )}
            initial={{
              opacity: 0,
...
export const ModalFooter = ({
  ...
  return (
    <div
      className={cn(
        "dark:bg-neutral-900 flex justify-end bg-gray-100 p-4",
        className,
      )}
    >
      {children}
